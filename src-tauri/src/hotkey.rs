...
pub static HOTKEY_KEY_CODE: AtomicU16 = AtomicU16::new(61); // Right Option default
...
#[cfg(target_os = "macos")]
mod macos {
    use super::{HOTKEY_FLAG_BIT, HOTKEY_KEY_CODE};
    use block2::RcBlock;
    ...
    pub fn install<F>(on_event: F) -> Option<Retained<AnyObject>>
    where
