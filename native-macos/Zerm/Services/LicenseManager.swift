...
final class LicenseManager {
    ...
    private let logger = Logger(subsystem: "com.arcusis.zerm", category: "LicenseManager")

    private let licenseKeyIdentifier = "zerm.license.key"
    private let trialStartDateIdentifier = "zerm.license.trialStartDate"
    private let activationIdIdentifier = "zerm.license.activationId"
