...
class LicenseViewModel: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.arcusis.zerm", category: "LicenseViewModel")
    ...
    private func loadLicenseState() {
        ...
        if let storedLicenseKey = licenseManager.licenseKey {
            ...
            if licenseManager.activationId != nil || !userDefaults.bool(forKey: "ZermLicenseRequiresActivation") {
                licenseState = .licensed
        ...
        let hasLaunchedBefore = userDefaults.bool(forKey: "ZermHasLaunchedBefore")
        if !hasLaunchedBefore {
            // First launch - start trial automatically
            userDefaults.set(true, forKey: "ZermHasLaunchedBefore")
            startTrial()
            return
        }
    ...
    func validateLicense() async {
        ...
        do {
            ...
            if licenseCheck.requiresActivation {
                ...
                userDefaults.set(true, forKey: "ZermLicenseRequiresActivation")
                ...
                licenseManager.activationId = nil
                userDefaults.set(false, forKey: "ZermLicenseRequiresActivation")
    ...
    func removeLicense() {
        ...
        userDefaults.set(false, forKey: "ZermLicenseRequiresActivation")
        userDefaults.set(false, forKey: "ZermHasLaunchedBefore")  // Allow trial to restart
...
extension UserDefaults {
    var activationsLimit: Int {
        get { integer(forKey: "ZermActivationsLimit") }
        set { set(newValue, forKey: "ZermActivationsLimit") }
    }
}
