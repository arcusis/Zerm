            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    HStack(alignment: .lastTextBaseline, spacing: 8) { 
                        Text(licenseViewModel.licenseState == .licensed ? "Zerm Pro" : "Upgrade to Pro")
                ...
                if case .licensed = licenseViewModel.licenseState {
                    HStack(spacing: 40) {
                        Button {
                            if let url = URL(string: "https://github.com/Arcusis/Zerm/releases") {
                        ...
                        Button {
                            if let url = URL(string: "https://buymeacoffee.com/arcusis") {
                                NSWorkspace.shared.open(url)
                            }
                        } label: {
                            animatedTipJarItem()
        ...
        VStack(spacing: 40) {
            ...
            VStack(spacing: 20) {
                ...
                HStack(spacing: 12) {
                    ...
                    Button(action: {
                        if let url = URL(string: "https://polar.sh/arcusis/portal/request") {
                            NSWorkspace.shared.open(url)
                        }
                    }) {
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use Zerm Pro on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
