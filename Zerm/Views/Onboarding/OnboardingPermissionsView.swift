...
struct OnboardingPermissionsView: View {
    ...
    private let permissions: [OnboardingPermission] = [
        ...
        OnboardingPermission(
            ...
            description: "Select the audio input device you want to use with Zerm.",
            icon: "headphones",
            type: .audioDeviceSelection
        ),
        OnboardingPermission(
            title: "Accessibility Access",
            description: "Allow Zerm to help you type anywhere in your Mac.",
            icon: "accessibility",
            type: .accessibility
        ),
        OnboardingPermission(
        ...
        OnboardingPermission(
            ...
            description: "Set up a keyboard shortcut to quickly access Zerm from anywhere.",
            icon: "keyboard",
                                ...
                                HStack(spacing: 8) {
                                    ...
                                    if permissions[currentPermissionIndex].type == .screenRecording {
                                        InfoTip(
                                            ...
                                            learnMoreURL: "https://tryzerm.com/docs/contextual-awareness"
                                        )
                                    }
                                }
