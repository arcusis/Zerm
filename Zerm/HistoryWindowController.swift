...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    private let windowIdentifier = NSUserInterfaceItemIdentifier("com.arcusis.zerm.historyWindow")
    private let windowAutosaveName = NSWindow.FrameAutosaveName("ZermHistoryWindowFrame")

    private override init() {
        super.init()
    }

    func showHistoryWindow(modelContainer: ModelContainer, engine: ZermEngine) {
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, engine: ZermEngine) -> NSWindow {
