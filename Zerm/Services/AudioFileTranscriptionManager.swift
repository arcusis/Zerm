...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.arcusis.zerm", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: ZermEngine) {
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: ZermEngine) async {
