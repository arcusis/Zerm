...
enum PunctuationCleanupMode: String, Codable, CaseIterable, Identifiable {
    ...
    var displayName: String {
        ...
        case .removeTrailingPeriod: return "Remove trailing period"
        }
    }
...
struct TranscriptionOutputFilter {
    private static let logger = Logger(subsystem: "com.arcusis.zerm", category: "TranscriptionOutputFilter")
    ...
    static func applyCleanupPreferences(
        ...
        guard punctuationMode != .keep || shouldLowercase else { return text }
